...
//CODE HERE
let compareNums = (num1,num2) => {if(num1>num2) console.log(`$(num1) is bigger number`)
else if (num2>num1)
console.log(`${num2} is bigger number`)
else
console.log(`both are equal(${num2})`)
}
compareNums(21,22)
compareNums(65,78)
compareNums(6,6)
...
{
  const WithparseInt1 = parseInt(num1)
  const WithparseInt2 = parseInt(num2)
  return(WithparseInt1+WithparseInt2)
}
let sum = add('50',66)
console.log(sum)
